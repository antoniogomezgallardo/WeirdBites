...
test.describe('Responsive Error Scenarios', () => {
  ...
  test.describe('Empty States', () => {
    test('should render empty state gracefully on mobile', async ({ page }) => {
    ...
    test('should render empty state gracefully on tablet', async ({ page }) => {
    ...
    test('should render empty state gracefully on desktop', async ({ page }) => {
