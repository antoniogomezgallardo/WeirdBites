...
**Business Context**:
- [1.business-requirements.md](1.business-requirements.md) - Business context, scope, rules
...
### Q: Do I need to read ALL 9 documents before coding?

**A**: **Core** (must read): 0, 3, 5, 6, 8, 9 (~3 hours)
**Optional** (read as needed): 1, 2, 4, 7
