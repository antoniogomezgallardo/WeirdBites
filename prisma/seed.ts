  ...
  const products = await prisma.product.createMany({
    data: [
      ...
      },
      {
        ...
        price: 15.5,
        imageUrl: '/images/products/black-garlic-chocolate.png',
        category: 'Chocolate',
        origin: 'Japan',
        stock: 30,
      },
      {
        ...
        price: 8.99,
        imageUrl: '/images/products/sriracha-popcorn.png',
        category: 'Snacks',
        origin: 'USA',
        stock: 100,
      },
      ...
      },
      {
        ...
        price: 9.99,
        imageUrl: '/images/products/salted-egg-chips.png',
        category: 'Snacks',
        origin: 'Singapore',
        stock: 60,
      },
      {
        ...
        price: 18.0,
        imageUrl: '/images/products/matcha-kitkat.png',
        category: 'Chocolate',
        origin: 'Japan',
        stock: 40,
      },
      {
        ...
        price: 7.25,
        imageUrl: '/images/products/chili-mango-gummies.png',
        category: 'Candy',
        origin: 'Mexico',
        stock: 80,
      },
      {
        ...
        price: 5.5,
        imageUrl: '/images/products/seaweed-crisps.png',
        category: 'Snacks',
        origin: 'South Korea',
        stock: 90,
      },
      {
        ...
        price: 10.5,
        imageUrl: '/images/products/yuzu-gummies.png',
        category: 'Candy',
        origin: 'Japan',
        stock: 45,
      },
      {
        ...
        price: 6.99,
        imageUrl: '/images/products/tamarind-candy.png',
        category: 'Candy',
        origin: 'Thailand',
        stock: 70,
      },
      {
        ...
        price: 4.5,
        imageUrl: '/images/products/pocky-matcha.png',
        category: 'Snacks',
        origin: 'Japan',
        stock: 120,
      },
      {
        ...
        price: 11.99,
        imageUrl: '/images/products/dragon-fruit-chips.png',
        category: 'Snacks',
        origin: 'Vietnam',
        stock: 35,
      },
      {
        ...
        price: 8.5,
        imageUrl: '/images/products/lychee-jelly.png',
        category: 'Candy',
        origin: 'Taiwan',
        stock: 55,
      },
      {
        ...
        price: 7.99,
        imageUrl: '/images/products/kimchi-crackers.png',
        category: 'Snacks',
        origin: 'South Korea',
        stock: 65,
      },
      {
        ...
        price: 19.99,
        imageUrl: '/images/products/mochi-ice-cream.png',
        category: 'Dessert',
        origin: 'Japan',
        stock: 25,
      },
